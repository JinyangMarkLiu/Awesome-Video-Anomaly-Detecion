...
3.  `ICCV2023` [FPDM-VAD](https://openaccess.thecvf.com/content/ICCV2023/papers/Yan_Feature_Prediction_Diffusion_Model_for_Video_Anomaly_Detection_ICCV_2023_paper.pdf) Feature Prediction Diffusion Model for Video Anomaly Detection
